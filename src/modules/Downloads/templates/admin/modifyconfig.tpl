        ...
        <div>
            ...
            <fieldset>
                ...
                <div class="z-formrow">
                    ...
                    <input disabled type="checkbox" value="1" id="fulltext" name="fulltext"{if $modvars.Downloads.fulltext eq true} checked="checked"{/if}/>
                </div>

                <div class="z-formrow">
                    <label for="sortby">{gt text='Sort downloads by'}</label>
                    <span>
                    <select disabled id="sortby" name="sortby" size="1">
                    ...
                    <select disabled id="cclause" name="cclause" size="1">
                ...
                <div class="z-formrow">
                    ...
                    <input disabled id="newdownloads" type="text" name="newdownloads" value="{$modvars.Downloads.newdownloads|safetext}" size="40" maxlength="80" />
                </div>

                <div class="z-formrow">
                    <label for="topdownloads">{gt text='Number of top rated downloads'}</label>
                    <input disabled id="topdownloads" type="text" name="topdownloads" value="{$modvars.Downloads.topdownloads|safetext}" size="40" maxlength="80" />
                </div>

                <div class="z-formrow">
                    <label for="popular">{gt text='Number of popular download'}</label>
                    <input disabled id="popular" type="text" name="popular" value="{$modvars.Downloads.popular|safetext}" size="40" maxlength="80" />
                </div>
                ...
                <div class="z-formrow">
                    ...
                    <input disabled id="screenshotmaxsize" type="text" name="screenshotmaxsize" value="{$modvars.Downloads.screenshotmaxsize|safetext}" size="40" maxlength="80" />
                </div>

                <div class="z-formrow">
                    <label for="thumbnailmaxsize">{gt text='Maximum filesize for thumbnails'}</label>
                    <input disabled id="thumbnailmaxsize" type="text" name="thumbnailmaxsize" value="{$modvars.Downloads.thumbnailmaxsize|safetext}" size="40" maxlength="80" />
                </div>

                <div class="z-formrow">
                    <label for="thumbnailwidth">{gt text='Maximum thumbnail width (pixels)'}</label>
                    <input disabled id="thumbnailwidth" type="text" name="thumbnailwidth" value="{$modvars.Downloads.thumbnailwidth|safetext}" size="40" maxlength="80" />
                </div>

                <div class="z-formrow">
                    <label for="thumbnailheight">{gt text='Maximum thumbnail height (pixels)'}</label>
                    <input disabled id="thumbnailheight" type="text" name="thumbnailheight" value="{$modvars.Downloads.thumbnailheight|safetext}" size="40" maxlength="80" />
                </div>
            ...
            <fieldset>
                ...
                <div class="z-formrow">
                    ...
                    <input disabled type="checkbox" value="1" id="torrent" name="torrent"{if $modvars.Downloads.torrent eq true} checked="checked"{/if}/>
                </div>
                ...
                <div class="z-formrow">
                    ...
                    <input disabled type="checkbox" value="1" id="securedownload" name="securedownload"{if $modvars.Downloads.securedownload eq true} checked="checked"{/if}/>
                </div>

                <div class="z-formrow">
                    <label for="captchacharacters">{gt text='Number of characters for captcha'}</label>
                    <input disabled id="captchacharacters" type="text" name="captchacharacters" value="{$modvars.Downloads.captchacharacters|safetext}" size="40" maxlength="80" />
                </div>
                ...
                <div class="z-formrow">
                    ...
                    <input disabled type="checkbox" value="1" id="allowscreenshotupload" name="allowscreenshotupload"{if $modvars.Downloads.allowscreenshotupload eq true} checked="checked"{/if}/>
                </div>
            ...
            <fieldset>
                ...
                <div class="z-formrow">
                    ...
                    <input disabled type="checkbox" value="1" id="treeview" name="treeview"{if $modvars.Downloads.treeview eq true} checked="checked"{/if}/>
                </div>

                <div class="z-formrow">
                    <label for="lastxdlsactive">{gt text='Show latest downloads'}</label>
                    <input disabled type="lastxdlsactive" value="1" id="lastxdlsactive" name="lastxdlsactive"{if $modvars.Downloads.lastxdlsactive eq true} checked="checked"{/if}/>
                </div>

                <div class="z-formrow">
                    <label for="lastxdlsamount">{gt text='Number of latest downloads on start page'}</label>
                    <input disabled id="lastxdlsamount" type="text" name="lastxdlsamount" value="{$modvars.Downloads.lastxdlsamount|safetext}" size="40" maxlength="80" />
                </div>

                <div class="z-formrow">
                    <label for="topxdlsactive">{gt text='Show popular downloads'}</label>
                    <input disabled type="checkbox" value="1" id="topxdlsactive" name="topxdlsactive"{if $modvars.Downloads.topxdlsactive eq true} checked="checked"{/if}/>
                </div>

                <div class="z-formrow">
                    <label for="topxdlsamount">{gt text='Number of popular downloads on start page'}</label>
                    <input disabled id="topxdlsamount" type="text" name="topxdlsamount" value="{$modvars.Downloads.topxdlsamount|safetext}" size="40" maxlength="80" />
                </div>

                <div class="z-formrow">
                    <label for="ratexdlsactive">{gt text='Show top-rated downloads'}</label>
                    <input disabled type="checkbox" value="1" id="ratexdlsactive" name="ratexdlsactive"{if $modvars.Downloads.ratexdlsactive eq true} checked="checked"{/if}/>
                </div>

                <div class="z-formrow">
                    <label for="ratexdlsamount">{gt text='Number of top-rated downloads on start page'}</label>
                    <input disabled id="ratexdlsamount" type="text" name="ratexdlsamount" value="{$modvars.Downloads.ratexdlsamount|safetext}" size="40" maxlength="80" />
                </div>
            ...
            <fieldset>
                ...
                <div class="z-formrow">
                    ...
                    <input disabled id="notifymail" type="text" name="notifymail" value="{$modvars.Downloads.notifymail|safetext}" size="40" maxlength="80" />
                </div>

                <div class="z-formrow">
                    <label for="inform_user">{gt text='Send email to submittor'}</label>
                    <input disabled type="checkbox" value="1" id="inform_user" name="inform_user"{if $modvars.Downloads.inform_user eq true} checked="checked"{/if}/>
                </div>
            ...
            <fieldset>
                ...
                <div class="z-formrow">
                    ...
                    <input disabled type="checkbox" value="1" id="importfrommod" name="importfrommod"{if $modvars.Downloads.importfrommod eq true} checked="checked"{/if}/>
                </div>
